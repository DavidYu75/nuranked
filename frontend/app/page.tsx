  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div
          ref={logoRef}
          className="relative flex items-center gap-6 left-4 select-none z-0"
        >
          <span className="text-6xl font-bold text-black font-docallisme">
            NU
          </span>
          <SplineIcon
            className="w-23 h-55"
      ...
      <div className="w-full flex flex-col items-center mt-[-60] bg-white z-10 relative">
        <div className="w-full max-w-2xl bg-white">
          {loading ? (
            <div key="loading" className="p-8 text-center text-black">
              Loading leaderboard...
            </div>
          ) : leaderboard.length === 0 ? (
            <div key="empty" className="p-8 text-center text-black">
            ...
            leaderboard.map((entry, idx) => (
              ...
              >
                ...
                <div className="w-28 px-2 py-2 text-black">
                  {entry.education?.graduation_year
                    ? `Class: ${entry.education.graduation_year}`
                    : "Class: N/A"}
                </div>
                ...
                <div className="w-20 px-2 py-2 text-lg font-mono text-black text-right">
                  {entry.elo_rating}
                </div>
              </div>
            ))
